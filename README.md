...
concepts: regression, cross-entropy loss (CSE), convexity, logarithms in loss functions, gradients for cross-entropy, sigmoid differentiation, logistic function, partial derivatives, gradient descent, permutation data shuffling.
